...
const Create = () => {
    ...
    return(
        <div className="container panel" style={{backgroundColor:""}}>
            <h1>Ask a public question</h1>
            <form className="box-shdow theme-adjust" onSubmit = {askQuestion}>
                <div className="form-group">
                    <p className="form-label">Title</p>
                    <p>Be specific and imagine you're asking a question to another person</p>
                    <input type="text" className="form-control" placeholder = "e.g. Is there anything going inside your mind?"
                ...
                <div className="form-group">
                    <input type="submit" value="Submit" className="form-control btn blue-background white-text btn btn-primary login"/>
                </div>
            </form>
        </div>
    )
